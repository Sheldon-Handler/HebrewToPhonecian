...
//    }
    ...
    public void setHebrewToPhoenicianMap() {
        ...
        hebrewToPhoenicianMap.put("ﬡ", "𐤀");
        hebrewToPhoenicianMap.put("אַ", "𐤀");
        hebrewToPhoenicianMap.put("אָ", "𐤀");
        hebrewToPhoenicianMap.put("אּ", "𐤀");
        hebrewToPhoenicianMap.put("ﭏ", "𐤀𐤋");
        hebrewToPhoenicianMap.put("בּ", "𐤁");
        hebrewToPhoenicianMap.put("בֿ", "𐤁");
        hebrewToPhoenicianMap.put("גּ", "𐤂");
        hebrewToPhoenicianMap.put("ﬢ", "𐤃");
        hebrewToPhoenicianMap.put("דּ", "𐤃");
        hebrewToPhoenicianMap.put("ﬣ", "𐤄");
        hebrewToPhoenicianMap.put("הּ", "𐤄");
        hebrewToPhoenicianMap.put("וּ", "𐤅");
        hebrewToPhoenicianMap.put("וֹ", "𐤅");
        hebrewToPhoenicianMap.put("זּ", "𐤆");
        hebrewToPhoenicianMap.put("טּ", "𐤈");
        hebrewToPhoenicianMap.put("יִ", "𐤉");
        hebrewToPhoenicianMap.put("ײַ", "𐤉𐤉");
        hebrewToPhoenicianMap.put("יּ", "𐤉");
        hebrewToPhoenicianMap.put("ﬤ", "𐤊");
        hebrewToPhoenicianMap.put("ךּ", "𐤊");
        hebrewToPhoenicianMap.put("כּ", "𐤊");
        hebrewToPhoenicianMap.put("כֿ", "𐤊");
        hebrewToPhoenicianMap.put("ﬥ", "𐤋");
        hebrewToPhoenicianMap.put("לּ", "𐤋");
        hebrewToPhoenicianMap.put("ﬦ", "𐤌");
        hebrewToPhoenicianMap.put("מּ", "𐤌");
        hebrewToPhoenicianMap.put("נּ", "𐤍");
        hebrewToPhoenicianMap.put("סּ", "𐤎");
        hebrewToPhoenicianMap.put("ﬠ", "𐤏");
        hebrewToPhoenicianMap.put("ףּ", "𐤐");
        hebrewToPhoenicianMap.put("פּ", "𐤐");
        hebrewToPhoenicianMap.put("פֿ", "𐤐");
        hebrewToPhoenicianMap.put("צּ", "𐤑");
        hebrewToPhoenicianMap.put("קּ", "𐤒");
        hebrewToPhoenicianMap.put("ﬧ", "𐤓");
        hebrewToPhoenicianMap.put("רּ", "𐤓");
        hebrewToPhoenicianMap.put("שׁ", "𐤔");
        hebrewToPhoenicianMap.put("שׂ", "𐤔");
        hebrewToPhoenicianMap.put("שּׁ", "𐤔");
        hebrewToPhoenicianMap.put("שּׂ", "𐤔");
        hebrewToPhoenicianMap.put("שּ", "𐤔");
        hebrewToPhoenicianMap.put("ﬨ", "𐤕");
        hebrewToPhoenicianMap.put("תּ", "𐤕");
    }
